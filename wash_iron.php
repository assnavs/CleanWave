...
// Fetch items for Wash + Iron service
$query = "SELECT item_name, price, category FROM items WHERE service_type = 'wash+iron'";
...
<head>
    ...
    <title>Wash + Iron - CleanWave</title>
...
<div class="container">
    ...
    <form action="place_order.php" method="POST">
        ...
        <input type="hidden" name="service" value="wash+iron">
