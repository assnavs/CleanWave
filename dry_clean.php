...
// Fetch items for Dry Clean service
$query = "SELECT item_name, price, category FROM items WHERE service_type = 'dry clean'";
...
<head>
    ...
    <title>Dry Clean - CleanWave</title>
