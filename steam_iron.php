...
// Fetch items for Steam Iron service
$query = "SELECT item_name, price, category FROM items WHERE service_type = 'steam iron'";
...
<head>
    ...
    <title>Steam Iron - CleanWave</title>
...
<div class="container">
    ...
    <form action="place_order.php" method="POST">
        ...
        <input type="hidden" name="service" value="steam iron">
