...
// Fetch items for Wash + Fold service
$query = "SELECT item_name, price, category FROM items WHERE service_type = 'wash+fold'";
...
<head>
    ...
    <title>Wash + Fold - CleanWave</title>
